...
class Solver():
    ...
    def initialize_sim(self, lagrangian, initial_state, metric, granularity):
        self.dims = initial_state.shape[2]
...
#initial_cond = np.array([[[0.1  , 21  , 0    ,0]]
#                        ,[[0.6  , 21  , 0.04, 0.04]]])
#initial_cond = np.array([[[0.1  , 0  , 0    ,25]]
#                        ,[[0.6  , 0.04  , 0.04, 25]]])
#r=20
#dt = 0.1
#v = np.sqrt(0.5/r)
#initial_cond = np.array([[[0.1  , r+20 , 0    ,0]]
#                        ,[[0.1+dt , r+20  , v*dt, 0]]])
#initial_cond = np.array([[[0.0  , 5    , 0   ], [0.0  , 20  , 0    ]]
#                        ,[[0.5 , 5.05, 0.14 ], [0.2 , 20  , 0]]])
#initial_cond = np.array([[[0.0, 0.0, 0.9, 0]],
#                         [[0.01, 0.003, 0.899, 0]]])
#sol.initialize_sim(rel_lagrangian, initial_cond, kerr_metric, [100000,0.0001,1e-6])
#sol.full_sim()
sol.open_old()
